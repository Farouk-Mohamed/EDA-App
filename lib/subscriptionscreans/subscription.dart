...
import 'package:flutter_application_49/subscriptionscreans/subscriptionpremium.dart';
                      ...
                      child: Column(
                        children: [
                          SizedBox(
                            ...
                            child: Card(
                              elevation: selectway == Myway.first ? 10 : 0,
                              shape: RoundedRectangleBorder(
                                side: BorderSide(
                                    color: selectway == Myway.first
                                        ? Color(0xff363F63)
                                        : Color(0xffEFF0F6)),
                  ...
                  child: Ink(
                    child: InkWell(
                      ...
                      child: SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width * 0.9,
                        child: Card(
                          elevation: selectway == Myway.second ? 10 : 0,
                          shape: RoundedRectangleBorder(
                            side: BorderSide(
                                color: selectway == Myway.second
                                    ? Color(0xffB78638)
                                    : Color(0xffEFF0F6)),
                            borderRadius: BorderRadius.circular(20),
                          ),
