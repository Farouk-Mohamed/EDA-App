...
import 'package:flutter_application_49/categoresscren/subcatogeryscrean/subcatogeryscreanfinal.dart';
import 'package:flutter_application_49/custom/textformfiled.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Subcatogeryscrean2 extends StatelessWidget {
  const Subcatogeryscrean2({super.key});
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: const Text("General Test and Assay",
                            style: TextStyle(
                                fontSize: 20,
                      ...
                      Padding(
                        ...
                        child: const Text(
                          "General Test and Assay Description",
                          style: TextStyle(
                            fontSize: 12,
