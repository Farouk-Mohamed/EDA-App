...
import 'package:flutter_application_49/categoresscren/subcatogeryscrean/subcatogeryscrean2.dart';
import 'package:flutter_application_49/custom/textformfiled.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Subcatogeryscrean extends StatelessWidget {
  const Subcatogeryscrean({super.key});
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: const Text("GENERAL CHAPTERS",
                            style: TextStyle(
                                fontSize: 20,
